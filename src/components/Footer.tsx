        ...
        <div className='flex justify-between pb-6'>
            <div>
                ...
                <div className='flex gap-x-5'>
                    <a href="https://twitter.com/"><img className='cursor-pointer' src="/twitter.png" alt="Twitter" /></a>
                    <a href="https://www.instagram.com/"><img className='cursor-pointer' src="/instagram.png" alt="Instagram" /></a>
                    <a href="https://www.facebook.com/"><img className='cursor-pointer' src="/facebook.png" alt="Facebook" /></a>
                </div>
            </div>
            <div>
