    ...
    <footer className={`${styles.flexCenter} text-header_footer_text`}>
      <div className={`${styles.boxWidth} h-[270px] bg-section_text px-[20px] pt-[20px] pb-[44px]`}>
        ...
        <div className='flex justify-between pt-8'>
            ...
            <p className={`${styles.paragraph} text-header_footer_text tracking-widest ${styles.hover}`}><a href="https://app.rs.school/">The Rolling Scopes School</a></p>
            <p className={`${styles.paragraph} text-header_footer_text tracking-widest ${styles.hover}`}> <a href="https://github.com/Yden00">Yden00</a></p>
        </div>
      </div>
    </footer>
  );
